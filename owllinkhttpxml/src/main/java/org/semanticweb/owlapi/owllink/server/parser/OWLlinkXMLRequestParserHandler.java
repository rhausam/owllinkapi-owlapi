...
public class OWLlinkXMLRequestParserHandler extends MyOWLXMLParserHandler {
    ...
    public OWLlinkXMLRequestParserHandler(OWLOntology ontology, PrefixManagerProvider prov, org.semanticweb.owlapi.owllink.parser.OWLlinkElementHandler topHandler) {
        ...
        addFactory(new AbstractOWLlinkElementHandlerFactory(OWLlinkXMLVocabulary.CLASSIFY) {
            public OWLlinkRequestElementHandler createHandler(MyOWLXMLParserHandler handler) {
    ...
    @Override
    protected org.semanticweb.owlapi.owllink.parser.OWLlinkElementHandler createOWLlinkHandler(String localName) {
